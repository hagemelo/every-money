        ...
        <TableContainer>
            ...
            <TableWrapper>
                <Table>
                    <thead>
                        <tr>
                            <Th onClick={() => requestSort('Conta')}>Conta {sortConfig.key === 'Conta' && (sortConfig.direction === 'asc' ? '↑' : '↓')}</Th>
                            <Th onClick={() => requestSort('mesReferencia')}>Mês Referência {sortConfig.key === 'mesReferencia' && (sortConfig.direction === 'asc' ? '↑' : '↓')}</Th>
                            <Th onClick={() => requestSort('tipoCategoria')}>Tipo Categoria {sortConfig.key === 'tipoCategoria' && (sortConfig.direction === 'asc' ? '↑' : '↓')}</Th>
                    ...
                    <tbody> 
                        ...
                        {paginatedData && paginatedData.map(orcamento => (
                            <Tr key={orcamento.id}>
                                ...
                                <Td>{orcamento.tipoCategoria}</Td>
                                <Td>
                                    <PriceInTableLabel valor={orcamento.limite} />
                                </Td>
                            </Tr>
                        ))}
                    </tbody>
